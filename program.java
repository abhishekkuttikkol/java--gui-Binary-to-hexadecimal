...
class Binary extends JFrame implements ActionListener {
	...
	public static JFrame frame = new JFrame("Binary to Hexadecimal");
	public static JPanel panel = new JPanel();
	public static void main(String args[])
	{
		hex1 = new JLabel("BINARY");
		panel.add(hex1);
	...
	{ 
		...
		if(s.equals("Convert"))
		{
			...
			int decimal = Integer.parseInt(hexadecimal,2);
			String hexstr = Integer.toString(decimal,16);
			String hexstr1 = hexstr.toUpperCase();
			bin.setText("     "+hexstr1);
		}
		if(s.equals("Clear"))
		{
